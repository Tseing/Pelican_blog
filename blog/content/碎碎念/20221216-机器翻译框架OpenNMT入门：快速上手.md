...
也可以到 [<i class="fa fa-github"></i> OpenNMT-py/data/](https://github.com/OpenNMT/OpenNMT-py/tree/master/data) 在线查看数据长什么样子。
