...
了解在 RIME 上套用 Lua 脚本的方法后，相信编写自己的脚本也不觉得困难了，参考模版就能实现自己的奇思妙想。[<i class="fa fa-github"></i> librime-lua](https://github.com/hchunhui/librime-lua/tree/master) 提供了许多 Lua 脚本，已经实现了很多有意思的想法，供额外参考。
